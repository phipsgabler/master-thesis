...
always used with \(100\) particles, since lower values did lead to convergent chains.  Experiments
were conducted on XY, and performed single-threaded with exclusive resource usage.  The PG-runs with
50 observations were not completed due to the twelve hour time limit of the server.\todo{describe
  hardware}
