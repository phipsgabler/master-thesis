...
off-the-shelf Bayesian models were chosen: a Gaussian mixture model,
\begin{equation}
  \label{eq:gmm}
  \begin{aligned}
...
\begin{equation}
  ...
  \end{aligned}
\end{equation}
and an infinite mixture model in stick-breaking construction\todo{cite}, to represent a Bayesian
...
\end{lstlisting}
  ...
  \label{lst:evalation-models}
\end{lstfloat}

Three interesting metrics: compilation time, sampling speed, and performance of chains (although
this compares Gibbs to PG, not the implementation).

Concrete parameters in table
