...
fashionable depending on the dominating use-case and available languages and infrastructure.  While
...
learning, compiler-based approaches have regained popularity lately.  There are efforts to add
built-in automatic differentiation to the Swift programming language \parencite{swift2019}, and work
in Julia \parencite{innes2018don} has started to apply source transformation to the intermediate
representation of the compiler, which enables differentiating through complex control flow, custom
data types, and nested functions.

Generalizations of the kinds of analyses and transformations found in these systems can be found
under the term \emph{abstract interpretation} \todo{cite this}
...
% al., 2015), and PyTorch (Paszke et al., 2017). 
...
\parencite{goodman2014church} and Venture \parencite{mansinghka2014venture} to produce what in the
