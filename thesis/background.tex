...
\end{equation}
and the LLN for Markov chains holds.  (For discrete spaces, this relation is written more familiarly
a left eigenvalue equation on a stochastic matrix: \(\pi K = \pi\)).  The advantage of MCMC methods
is that they apply equally well to many structurally complex models, and treat densities in a
uniform way, without requiring special knowledge about the specific distribution in question.  I
