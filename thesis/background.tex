...
Carlo methods, based on sampling. Their fundamentsl idea is to derive, from a specified density, a
...
Langevin and Hamiltonian Monte Carlo (HMC).\todo{cite all that}
...
For further MCMC theory, see \cite{vihola2020lectures,murphy2012machine}.
