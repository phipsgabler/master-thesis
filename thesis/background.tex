...
\newthought{A key principle} in Julia's compilation model is type
...
become known only known at runtime, through singleton types such as \jlinl{Val}.
...
% numerical - symbolic - ad ; footnote: ad = symbolic with sharing
...
Instead of starting with a limit of tangents, more insight is provided by viewing it as a
