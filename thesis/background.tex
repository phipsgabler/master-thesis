...
\begin{figure}[t]
  \centering
  \subbottom[Forward mode graph.]{\includegraphics[width=\textwidth]{figures/comp-graph}}
  \bigskip
  \subbottom[Backward graph.]{\includegraphics[width=\textwidth]{figures/comp-graph-backward}}
  \caption{Text}
