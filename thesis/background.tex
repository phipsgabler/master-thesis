...
determinstic conventions under some technical conditions \parencite[see][chapter
...
structures should exist to allow complex behaviour, such as to\todo{page break}
\begin{itemize}
  \firmlist
...
figure~\ref{fig:comp-graph}\todo{larger dashes}, where we see the computation graph of a simple expression
...
purely structurally on the Julia IR, employing generated functions to analyze functions' code and
...
dependencies.  In our little example (withouth control flow), this leads to
\begin{equation}
