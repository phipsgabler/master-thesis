...
\title{Automatic Graph Tracking in Probabilistic Programs via Source Transformations}
...
\newcommand{\Exp}[2][\empty]{\mathbb{E}_{\! #1}[#2]}
\newcommand{\Var}[2][\empty]{\mathbb{V}_{\! #1}[#2]}
\newcommand{\Expd}[2][\empty]{\mathbb{E}_{\! #1}\!\left[#2\right]}
\newcommand{\Vard}[2][\empty]{\mathbb{V}_{\! #1}\left[#2\right]}
...
\newcommand{\MVNormal}[1]{\mathcal{N}_{\text{MV}}(#1)}
